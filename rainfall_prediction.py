...
plt.savefig('results/01_class_imbalance.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('results/02_balanced_dataset.png', dpi=300, bbox_inches='tight')
plt.close()

sns.heatmap(oversampled.isnull(), cbar=False, cmap='PuBu')
plt.savefig('results/03_missing_data_pattern.png', dpi=300, bbox_inches='tight')
plt.close()

total = oversampled.isnull().sum().sort_values(ascending=False)
percent = (oversampled.isnull().sum()/oversampled.isnull().count()).sort_values(ascending=False)
missing = pd.concat([total, percent], axis=1, keys=['Total', 'Percent'])
print(missing.head(4))
...
plt.savefig('results/04_correlation_heatmap.png', dpi=300, bbox_inches='tight')
plt.close()

sns.pairplot(data=MiceImputed, vars=('MaxTemp','MinTemp','Pressure9am','Pressure3pm', 'Temp9am', 'Temp3pm', 'Evaporation'), hue='RainTomorrow')
plt.savefig('results/05_pairplot.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('results/08_decision_regions.png', dpi=300, bbox_inches='tight')
plt.close()
...
ax1.set_ylabel(TIME_TAKEN_LABEL, fontsize=13, color=color)
ax2 = sns.barplot(x='Model', y=TIME_TAKEN_LABEL, data = data, palette='summer')
...
plt.savefig('results/06_model_comparison_accuracy_time.png', dpi=300, bbox_inches='tight')
plt.close()
...
plt.savefig('results/07_model_comparison_roc_kappa.png', dpi=300, bbox_inches='tight')
plt.close()

data.to_csv('results/model_comparison.csv', index=False)
